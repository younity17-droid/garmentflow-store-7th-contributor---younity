      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          {(whatsappQR || instagramQR) && (
            <>
              <Separator />
              <div className="flex justify-between items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-purple-50 dark:from-green-950 dark:to-purple-950 rounded-lg border-2 border-dashed">
                {whatsappQR && (
                  <div className="flex-1 text-center bg-white dark:bg-gray-900 rounded-lg p-3 shadow-sm">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      <p className="font-bold text-green-700 dark:text-green-400">WhatsApp</p>
                    </div>
                    <img src={whatsappQR} alt="WhatsApp" className="w-28 h-28 mx-auto mb-2" />
                    <p className="text-xs font-semibold text-green-800 dark:text-green-300 bg-green-100 dark:bg-green-900 px-3 py-1 rounded-full">{storeSettings?.whatsapp_tagline || "Join our WhatsApp Group"}</p>
                  </div>
                )}
                {instagramQR && (
                  <div className="flex-1 text-center bg-white dark:bg-gray-900 rounded-lg p-3 shadow-sm">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      ...
                      <p className="font-bold text-pink-700 dark:text-pink-400">Instagram</p>
                    </div>
                    <img src={instagramQR} alt="Instagram" className="w-28 h-28 mx-auto mb-2" />
                    <p className="text-xs font-semibold text-pink-800 dark:text-pink-300 bg-pink-100 dark:bg-pink-900 px-3 py-1 rounded-full">{storeSettings?.instagram_tagline || "Follow us on Instagram"}</p>
                  </div>
                )}
              </div>
            </>
